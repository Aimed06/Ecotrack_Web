    ...
    <div style={s.page}>
      ...
      <div style={s.card}>
        <div style={s.header}>
          ...
          <h1 style={s.title}>Espace Admin</h1>
...
const s: Record<string, React.CSSProperties> = {
  page: {
    ...
    background: 'linear-gradient(135deg, #1a1040 0%, #2d1f6e 50%, #3b2d8c 100%)',
    position: 'relative', overflow: 'hidden',
  },
  bg1: {
    position: 'absolute', inset: 0,
    background: `radial-gradient(ellipse at 30% 70%, ${Colors.purple}30 0%, transparent 55%)`,
  },
  bg2: {
    position: 'absolute', inset: 0,
    background: `radial-gradient(ellipse at 75% 20%, ${Colors.primary}18 0%, transparent 50%)`,
  },
  card: {
    position: 'relative',
  ...
  btn: {
    ...
    boxShadow: `0 8px 20px ${Colors.purple}50`,
